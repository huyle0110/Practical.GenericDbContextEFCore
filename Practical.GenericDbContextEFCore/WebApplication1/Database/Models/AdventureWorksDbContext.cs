...
public partial class AdventureWorksDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity.HasOne(d => d.StateProvince).WithMany(p => p.Address).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<BillOfMaterials>(entity =>
        {
            ...
            entity.HasOne(d => d.Component).WithMany(p => p.BillOfMaterialsComponent).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<BusinessEntityAddress>(entity =>
        {
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.BusinessEntityAddress).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.AddressType).WithMany(p => p.BusinessEntityAddress).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.BusinessEntityAddress).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<BusinessEntityContact>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.BusinessEntityContact).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ContactType).WithMany(p => p.BusinessEntityContact).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Person).WithMany(p => p.BusinessEntityContact).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<CountryRegionCurrency>(entity =>
        {
            ...
            entity.HasOne(d => d.CountryRegionCodeNavigation).WithMany(p => p.CountryRegionCurrency).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.CurrencyCodeNavigation).WithMany(p => p.CountryRegionCurrency).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<CurrencyRate>(entity =>
        {
            ...
            entity.HasOne(d => d.FromCurrencyCodeNavigation).WithMany(p => p.CurrencyRateFromCurrencyCodeNavigation).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ToCurrencyCodeNavigation).WithMany(p => p.CurrencyRateToCurrencyCodeNavigation).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<EmailAddress>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.EmailAddress).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<EmployeeDepartmentHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.EmployeeDepartmentHistory).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Department).WithMany(p => p.EmployeeDepartmentHistory).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Shift).WithMany(p => p.EmployeeDepartmentHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<EmployeePayHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.EmployeePayHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<PersonCreditCard>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.PersonCreditCard).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.CreditCard).WithMany(p => p.PersonCreditCard).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<PersonPhone>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.PersonPhone).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.PhoneNumberType).WithMany(p => p.PersonPhone).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductCostHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductCostHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductInventory>(entity =>
        {
            ...
            entity.HasOne(d => d.Location).WithMany(p => p.ProductInventory).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Product).WithMany(p => p.ProductInventory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductListPriceHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductListPriceHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductModelIllustration>(entity =>
        {
            ...
            entity.HasOne(d => d.Illustration).WithMany(p => p.ProductModelIllustration).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ProductModel).WithMany(p => p.ProductModelIllustration).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductModelProductDescriptionCulture>(entity =>
        {
            ...
            entity.HasOne(d => d.Culture).WithMany(p => p.ProductModelProductDescriptionCulture).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ProductDescription).WithMany(p => p.ProductModelProductDescriptionCulture).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ProductModel).WithMany(p => p.ProductModelProductDescriptionCulture).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductProductPhoto>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductProductPhoto).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ProductPhoto).WithMany(p => p.ProductProductPhoto).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductReview>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ProductReview).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductSubcategory>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductCategory).WithMany(p => p.ProductSubcategory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ProductVendor>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.ProductVendor).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Product).WithMany(p => p.ProductVendor).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.UnitMeasureCodeNavigation).WithMany(p => p.ProductVendor).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<PurchaseOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.PurchaseOrderDetail).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.PurchaseOrder).WithMany(p => p.PurchaseOrderDetail).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<PurchaseOrderHeader>(entity =>
        {
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.PurchaseOrderHeader).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ShipMethod).WithMany(p => p.PurchaseOrderHeader).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Vendor).WithMany(p => p.PurchaseOrderHeader).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesOrderHeader>(entity =>
        {
            ...
            entity.HasOne(d => d.BillToAddress).WithMany(p => p.SalesOrderHeaderBillToAddress).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Customer).WithMany(p => p.SalesOrderHeader).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ShipMethod).WithMany(p => p.SalesOrderHeader).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.ShipToAddress).WithMany(p => p.SalesOrderHeaderShipToAddress).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesOrderHeaderSalesReason>(entity =>
        {
            ...
            entity.HasOne(d => d.SalesReason).WithMany(p => p.SalesOrderHeaderSalesReason).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesPersonQuotaHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.SalesPersonQuotaHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesTaxRate>(entity =>
        {
            ...
            entity.HasOne(d => d.StateProvince).WithMany(p => p.SalesTaxRate).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesTerritory>(entity =>
        {
            ...
            entity.HasOne(d => d.CountryRegionCodeNavigation).WithMany(p => p.SalesTerritory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SalesTerritoryHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.BusinessEntity).WithMany(p => p.SalesTerritoryHistory).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Territory).WithMany(p => p.SalesTerritoryHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<ShoppingCartItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ShoppingCartItem).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<SpecialOfferProduct>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.SpecialOfferProduct).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.SpecialOffer).WithMany(p => p.SpecialOfferProduct).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<StateProvince>(entity =>
        {
            ...
            entity.HasOne(d => d.CountryRegionCodeNavigation).WithMany(p => p.StateProvince).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.Territory).WithMany(p => p.StateProvince).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<TransactionHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.TransactionHistory).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<WorkOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.WorkOrder).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<WorkOrderRouting>(entity =>
        {
            ...
            entity.HasOne(d => d.Location).WithMany(p => p.WorkOrderRouting).OnDelete(DeleteBehavior.ClientSetNull);

            entity.HasOne(d => d.WorkOrder).WithMany(p => p.WorkOrderRouting).OnDelete(DeleteBehavior.ClientSetNull);
        });
